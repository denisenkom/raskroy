...
namespace CuttingOptimizerTester
{
	class Program
	{
		static void Main(string[] args)
		{
			...
			optimizer.Parts.Add(new Part(Decimal.Parse("200"), Decimal.Parse("300"), 3, false));
			optimizer.Sheets.Add(new Sheet(Decimal.Parse("2730"), Decimal.Parse("1830")));
			optimizer.Parameters.CutterThickness = Decimal.Parse("4.4", CultureInfo.InvariantCulture);
			optimizer.Parameters.CutOffBottom = Decimal.Parse("13");

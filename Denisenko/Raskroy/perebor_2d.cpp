...
namespace raskroy
{
	...
	//
	inline bool perebor_2d::bylen_bywid(const t_rect &rect, t_stat &stat, int s, t_raskroy &raskroy, t_amounts &rashod)
	{
	...
	//		[o] rashod - расход деталей
	//
	bool perebor_2d::recursive(t_sizes::iterator begin, const t_rect &rect, t_stat &stat, int s, t_raskroy &raskroy, t_amounts &rashod)
	{
